...
window.AKILI_SCAN_CONFIGS = {
  ...
  subdomains: { endpoint: '/api/v1/scan/subdomains', field: 'domain', placeholder: 'example.com', color: 'var(--mod-subdomain)', title: 'Subdomain Finder', desc: 'Scan a domain to find its subdomains (very effective!)' },
